...
use Satupersen\Contracts\Queue\Factory as QueueManager;
use Satupersen\Database\DetectsLostConnections;
use Satupersen\Queue\Events\JobExceptionOccurred;
use Satupersen\Queue\Events\JobProcessed;
use Satupersen\Queue\Events\JobProcessing;
use Satupersen\Queue\Events\Looping;
use Satupersen\Queue\Events\WorkerStopping;
...
class Worker
{
     ...
     *
     * @var \Satupersen\Contracts\Queue\Factory
     */
    protected $manager;
     ...
     *
     * @var \Satupersen\Contracts\Debug\ExceptionHandler
     */
     ...
     *
     * @param  \Satupersen\Contracts\Queue\Factory  $manager
     * @param  \Satupersen\Contracts\Events\Dispatcher  $events
     * @param  \Satupersen\Contracts\Debug\ExceptionHandler  $exceptions
     ...
     * @param  string  $queue
     * @param  \Satupersen\Queue\WorkerOptions  $options
     * @return void
     */
     ...
     *
     * @param  \Satupersen\Contracts\Queue\Job|null  $job
     * @param  \Satupersen\Queue\WorkerOptions  $options
     * @return void
     */
     ...
     *
     * @param  \Satupersen\Contracts\Queue\Queue  $connection
     * @param  string  $queue
     ...
     *
     * @param  \Satupersen\Contracts\Queue\Job  $job
     * @param  string  $connectionName
     * @param  \Satupersen\Queue\WorkerOptions  $options
     * @return void
     */
     ...
     *
     * @param  \Satupersen\Contracts\Queue\Job  $job
     * @return \Satupersen\Queue\MaxAttemptsExceededException
     */
     ...
     *
     * @return \Satupersen\Queue\QueueManager
     */
