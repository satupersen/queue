...
namespace Satupersen\Queue\Capsule;

use Satupersen\Container\Container;
use Satupersen\Queue\QueueManager;
use Satupersen\Queue\QueueServiceProvider;
use Satupersen\Support\Traits\CapsuleManagerTrait;

/**
 * @mixin \Satupersen\Queue\QueueManager
 * @mixin \Satupersen\Contracts\Queue\Queue
 */
class Manager
{
     ...
     *
     * @var \Satupersen\Queue\QueueManager
     */
    protected $manager;
